...
async function action(): Promise<void> {
	...
	const body: any = {
		...
		"Организация_Key": financial_assistance_data.staff.organization_id,
		...
		"Начисления": [
			{
				"LineNumber": "1",
				"Сотрудник_Key": financial_assistance_data.staff.id_1c,
				"Подразделение_Key": financial_assistance_data.staff.structural_subdivision_id,
				"ДатаНачала": financial_assistance_data.creationAt,
				"ДатаОкончания": financial_assistance_data.creationAt,
	...
	integration_app.data.personal_guid_1c = JSON.stringify([financial_assistance_data.staff.individual_id_1c])
